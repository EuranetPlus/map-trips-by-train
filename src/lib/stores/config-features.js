export const config = {
	mapTitle: 'trips-by-train', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-trips-by-train.vercel.app/', // The url provided when deploying the map on Vercel
